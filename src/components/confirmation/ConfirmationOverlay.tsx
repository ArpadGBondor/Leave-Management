...
export default function ConfirmationOverlay() {
  ...
  return (
    <div className="absolute top-0 bottom-0 left-0 right-0 z-50 flex items-center justify-center bg-black/40">
      <div className="max-w-lg m-4 md:m-8 p-8 rounded-xl border-4 border-brand-green-500 bg-brand-purple-50 overflow-auto space-y-4">
        <h2 className="text-3xl font-bold text-brand-purple-700">
          {options.title}
        </h2>
