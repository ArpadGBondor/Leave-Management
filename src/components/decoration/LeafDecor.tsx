...
const adjacentTheme: Record<keyof typeof themes, keyof typeof themes> = {
  'purple-1': 'green-4',
  'purple-2': 'green-3',
  'purple-3': 'green-2',
  'purple-4': 'green-1',
    ...
    >
      <div
        className={`absolute z-0 ${
          sizes[size]
        } rounded-full rounded-bl-none rounded-tr-none ${
          themes[adjacentTheme[theme]]
        } top-[10%] -left-[10%]`}
      >
        <div
          className={`absolute z-0 ${sizes[size]} rounded-full rounded-bl-none rounded-tr-none ${themes[theme]} top-[10%] -left-[10%]`}
        >
          <div
            className={`absolute z-0 ${
              sizes[size]
