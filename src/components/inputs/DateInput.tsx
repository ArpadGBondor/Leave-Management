    ...
    <div className="flex flex-col gap-1">
      ...
      <div className="flex items-center gap-2">
        <button
          ...
          className={`relative flex flex-row justify-between items-center w-full rounded-full border transition duration-200 px-4 py-2 cursor-pointer select-none ring-offset-brand-purple-50 focus:ring-2 focus:ring-offset-2 focus:outline-none
          ${
            disabled
