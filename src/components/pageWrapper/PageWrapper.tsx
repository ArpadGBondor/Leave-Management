...
export default function PageWrapper({
  ...
  return (
    <div
      className={`w-full h-full sm:w-auto sm:h-auto min-w-md ${
        variant === 'primary'
      ...
      }  p-0 sm:p-6 lg:p-8 sm:pt-2 lg:pt-4 m-0 sm:m-4 lg:m-8 rounded-none sm:rounded-xl flex flex-col justify-stretch items-stretch ${size} overflow-hidden`}
    >
      <header className="mb-2 sm:mb-4">
        <h1 className=" pl-4 sm:pl-0 text-4xl font-bold text-white  [text-shadow:_1px_1px_1px_rgba(255,255,255,0.25),_-1px_-1px_1px_rgba(0,0,0,0.5)]">
          {title}
        </h1>
      </header>
      <div
