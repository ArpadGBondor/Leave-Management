...
import { CompanyState } from './CompanyContext';
...
export type CompanyAction =
  ...
  | {
      type: typeof SET_BANK_HOLIDAYS_CACHE;
      payload: { key: string; dates: Date[] };
    }
...
export const loadingReducer = (
  ...
  switch (action.type) {
    ...
    case SET_BANK_HOLIDAYS_CACHE:
      return {
        ...state,
        bankHolidayCache: {
          ...state.bankHolidayCache,
          [action.payload.key]: action.payload.dates,
        },
      };
